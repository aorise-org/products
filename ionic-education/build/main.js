...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models_video__ = __webpack_require__(304);
...
var VideoPage = (function () {
    ...
    function VideoPage(navCtrl, navParams, httpService) {
        ...
        this.videoId = this.navParams.data.id;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models_preview__ = __webpack_require__(311);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_service__ = __webpack_require__(114);
...
var PreviewPage = (function () {
    function PreviewPage(app, navCtrl, navParams, httpService) {
        ...
        this.httpService = httpService;
        console.log(this.navParams.data);
        this.previewId = this.navParams.data.id;
        this.previewType = this.navParams.data.type;
        console.log("previewId = " + this.previewId + " ;previewType = " + this.previewType);
...
var DetailsPage = (function () {
    ...
    DetailsPage.prototype.afterLoadComplete = function (pdfData) {
        this.totalPages = pdfData.numPages;
        this.isLoaded = true;
    };
    DetailsPage.prototype.nextPage = function () {
        this.page++;
    };
    DetailsPage.prototype.prevPage = function () {
        this.page--;
    };
    return DetailsPage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_module__ = __webpack_require__(255);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ngx_translate_http_loader__ = __webpack_require__(324);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__angular_common_http__ = __webpack_require__(216);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_ng2_pdf_viewer__ = __webpack_require__(326);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_ionic2_rating__ = __webpack_require__(361);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__components_education_app_education_app__ = __webpack_require__(363);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_education_detail_education_detail__ = __webpack_require__(364);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_16__components_education_app_education_app__["a" /* EducationAppComponent */],
            __WEBPACK_IMPORTED_MODULE_17__components_education_detail_education_detail__["a" /* EducationDetailComponent */]
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["a" /* BrowserModule */],
            __WEBPACK_IMPORTED_MODULE_13__angular_common_http__["b" /* HttpClientModule */],
            __WEBPACK_IMPORTED_MODULE_14_ng2_pdf_viewer__["PdfViewerModule"],
            __WEBPACK_IMPORTED_MODULE_15_ionic2_rating__["a" /* Ionic2RatingModule */],
            ...
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["d" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_5__app_component__["a" /* MyApp */], {}, {
                links: [
                    { component: __WEBPACK_IMPORTED_MODULE_7__pages_video_video__["a" /* VideoPage */], name: 'Video', segment: 'video/:id' },
                    { component: __WEBPACK_IMPORTED_MODULE_8__pages_preview_preview__["a" /* PreviewPage */], name: 'Preview', segment: 'preview/:id/:type' }
                ]
            })
        ],
...
EducationDetailComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'education-detail',template:/*ion-inline-start:"D:\AoriseGit\ionic-education\src\components\education-detail\education-detail.html"*/'<!-- Generated template for the EducationDetailComponent component -->\n<div class="padding">\n\n  <!--课程名字 -->\n  <div>\n    <label class="content-title"> {{detailPreview.name}} </label>\n\n    <table>\n      <tr>\n        <td class="margin">\n          <rating [(ngModel)]="detailPreview.rate"\n                  readOnly="true"\n                  max="5"\n                  emptyStarIconName="star-outline"\n                  halfStarIconName="star-half"\n                  starIconName="star"\n                  nullable="false">\n          </rating>\n        </td>\n        <td>\n          <label class="content-body"> {{detailPreview.count}} </label>\n          <label class="content-body"> {{ \'LEARNED\' | translate }} </label>\n        </td>\n      </tr>\n    </table>\n\n  </div>\n  <hr>\n\n  <!--课程介绍 -->\n  <div>\n    <p class="content-title"> {{ \'CONTENT_TITLE\' | translate }} </p>\n    <p class="content-body"> {{detailPreview.description}} </p>\n  </div>\n  <hr>\n\n  <!--老师介绍 -->\n  <div *ngIf="detailPreview.teacherName">\n    <p class="content-title"> {{ \'LECTURER\' | translate }} </p>\n\n    <table>\n      <tr>\n        <td class="margin">\n          <img class="radius-avatar" [src]="detailPreview.teacherAvatar">\n        </td>\n        <td>\n          <p class="content-body"> {{detailPreview.teacherName}} </p>\n          <p class="content-body"> {{detailPreview.teacherInfo}} </p>\n        </td>\n      </tr>\n    </table>\n  </div>\n</div>\n'/*ion-inline-end:"D:\AoriseGit\ionic-education\src\components\education-detail\education-detail.html"*/
    }),
